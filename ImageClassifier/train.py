...
model = model_mang.building_network(network_architecture, hidden_units)
model.class_to_idx = train_data.class_to_idx

model, criterion = model_mang.training_network(model, epochs, learning_rate, trainloader, validloader, gpu)
model_mang.evaluating_model(model, testloader, criterion, gpu)
model_mang.saving_model(model, network_architecture, hidden_units, epochs, learning_rate, save_dir)